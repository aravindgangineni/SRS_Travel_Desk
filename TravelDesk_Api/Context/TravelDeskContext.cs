    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>().HasData(
            new User
            {
                ...
                PasswordHash = Encoding.UTF8.GetBytes(adminPasswordHash),
                RoleId = 1,
                FirstName = "System",
                LastName = "Admin",
                EmployeeId = "A001",
            ...
            new User
            {
                ...
                PasswordHash = Encoding.UTF8.GetBytes(hrPasswordHash),
                RoleId = 2,
                FirstName = "Hr",
                LastName = "Travel",
                EmployeeId = "T001",
            ...
            new User
            {
                ...
                PasswordHash = Encoding.UTF8.GetBytes(managerPasswordHash),
                RoleId = 4,
                FirstName = "Project",
                LastName = "Manager",
                EmployeeId = "M001",
